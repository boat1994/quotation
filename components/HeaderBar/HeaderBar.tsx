...
const HeaderBar: React.FC<HeaderBarProps> = ({ onPreferencesOpen, language, setLanguage }) => {
    return (
        <div className="header-bar">
            <button onClick={onPreferencesOpen} className="preferences-btn" aria-label="Preferences">
