...
export const translations = {
  ...
  th: {
    ...
    copy_post_payment_info_v2: 'หลังจากได้รับยอดมัดจำแล้ว ทางร้านจะรีบดำเนินกระบวนการผลิตทันที ซึ่งจะใช้เวลาประมาณ 14-21 วันทำการ เพื่อสร้างสรรค์ผลงานชิ้นนี้อย่างสุดฝีมือเลยครับ',
    copy_cancellation_header_v2: '',
